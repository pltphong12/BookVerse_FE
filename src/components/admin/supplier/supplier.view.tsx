                    ...
                    <div className="flex items-center space-x-4">
                        <div className="avatar">
                            <div className="w-28 h-28 rounded-full ring ring-gray-700 ring-offset-base-100 ring-offset-2 overflow-hidden">
                                <img src={`${import.meta.env.VITE_BACKEND_URL}/storage/supplier/${supplier.image}`} alt="User Avatar" />
                            </div>
                        </div>
                        <div>
                            <h4 className="text-lg font-semibold">{supplier.name}</h4>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Email: {supplier.email}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2">
                            ...
                            <p className="text-gray-900 dark:text-white">
                                {supplier.createdAt && new Intl.DateTimeFormat('en-US', {
                                    year: 'numeric',
                                    month: '2-digit',
                                    day: '2-digit',
                                    hour: '2-digit',
                        ...
                        <div className="col-span-2">
                            ...
                            <p className="text-gray-900 dark:text-white">{supplier.description}</p>
                        </div>
