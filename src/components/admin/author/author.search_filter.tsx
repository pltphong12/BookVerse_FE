...
export const AuthorSearchAndFilter: React.FC<AuthorSearchAndFilterProps> = ({ searchWithName, setSearchWithName, searchWithNationality, setSearchWithNationality, dateFrom, setDateFrom, setPage }) => {
                    ...
                    <div className='space-y-2'>
                        ...
                        <div className="relative flex-1 sm:max-w-md mb-4 sm:mb-0">
                            ...
                            <input
                                ...
                                onChange={(events) => {
                                    events.preventDefault()
                                    setSearchWithNationality(events.target.value)
                                    setPage(1)
                                    console.log(events.target.value)
                                }}
                                placeholder="Nhập quê quán tác giả"
                                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                            />
                        </div>
                    </div>
